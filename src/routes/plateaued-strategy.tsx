...
export const Route = createFileRoute("/plateaued-strategy")({
  head: () => ({
    meta: [
      { title: "Breaking a Score Plateau — Credencementor" },
      {
        name: "description",
        content:
          "Mock scores stuck in the same band? Here's the leak-audit and drill plan Credencementor mentors use to restart rank movement.",
      },
      { property: "og:title", content: "Breaking a Score Plateau — Credencementor" },
      {
