...
export const Route = createFileRoute("/rank-jump-plan")({
  head: () => ({
    meta: [
      { title: "Closing the Last Thousand Ranks — Aura Mentorship" },
      {
        name: "description",
        content:
          "Missed your target college by a whisker? Fix attempt strategy, accuracy and nerve with an Aura mentor.",
      },
      { property: "og:title", content: "Closing the Last Thousand Ranks — Aura Mentorship" },
      {
